...
//This class handles shift-clicking in all of our containers
public class WYMLContainer extends AbstractContainerMenu
{
    public WYMLContainer(@Nullable MenuType<?> menuType, int i)
    {
        super(menuType, i);
    }
